...
const About = () => {
  return (
    <div className="md:h-[750px] 2xl:h-[1200px] xl:h-[1000px] flex justify-center  h-auto overflow-hidden w-full p-5" >
        ...
        <div
           className=" flex flex-col mt-4  md:mb-[330px] xl:mt-[10px] 2xl:mt-[1px] md:gap-5 " >
               <motion.div
               ...
               className="flex p-2 xl:text-2xl 2xl:text-3xl md:gap-10 gap-4 items-center ml-14 md:ml-0  2xl: " >
                   <p>02</p>
            ...
            className='p-3 md:w-[325px] xl:w-[370px] 2xl:w-[430px]  xl:mt-10 2xl:mt-1 w-[430px] text-center overflow-hidden flex flex-col gap-7  md:gap-10 xl:gap-8 2xl:gap-11' >
               <motion.p 
                variants={fadeIn("up",0.3)}
                initial="hidden"
                whileInView={"show"}
                viewport={{once:true,amount:0.7}}
               className="2xl:text-5xl xl:text-4xl space-y-3 font-ivarfine text-center mx-3 md:mx-0 " >With over $19 Billion in luxury home sales,  Aaron Kirman represents the finest estates across the globe and was ranked in the top 5 luxury real estate agents in the US by the Wall Street Journal.</motion.p>
               <p
                variants={fadeIn("up",0.3)}
                initial="hidden"
                whileInView={"show"}
            ...
            <div className="flex mt-3 2xl:text-3xl xl:text-2xl gap-5 relative p-3  md:p-0 flex-col ml-32 md:ml-20 md:mt-16 xl:mt-20 xl:p-2 2xl:p-3  group group-hover:border transition-all duration-500 hover:bg-black w-[150px] 2xl:w-[250px] xl:w-[170px] hover:border-black  hover:text-white" >
                ...
                <hr className="border-y-2 absolute top-6 left-0 md:top-4 2xl:top-[68px]  xl:top-10 border-black w-16 mt-5 group-hover:w-[140px]  transition-transform duration-200" ></hr>
            </div>
            </motion.div>
            <motion.div 
             ...
             whileInView={"show"}
             viewport={{once:true,amount:0.7}}
            className='p-3 w-[325px] font-proxima xl:text-lg 2xl:text-2xl 2xl:w-[370px] xl:w-[350px]  hidden md:flex flex-col gap-14 xl:gap-10'>
                <motion.p 
                variants={fadeIn1("up",0.2)}
                initial="hidden"
                whileInView={"show"}
